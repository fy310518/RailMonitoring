...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.fy.baselibrary.utils.imgload.imgprogress.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.fy.baselibrary.utils.imgload.imgprogress.GlideOptions().apply(toSet));
    }
  }
}
